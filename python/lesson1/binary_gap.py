...
def solution(N):
    ...
    The number 529 has binary representation 1000010001 and contains two binary gaps: one of length 4 and one of
    length 3.
    ...
    :param N: an integer
    :return: the binary gap of N
    """
    bin_n = bin(N)[2:]
    # print(bin_n)
    end = util.strings.last_index_of('1', bin_n)
    if end > 1:
        max_count = 0
        counter = 0
        for i in range(1, end, 1):
            ...
            if counter > max_count:
                max_count = counter
            # print("i={}, char={}, counter={}, max_count={}".format(i, bin_n[i], counter, max_count))
        return max_count
    return 0
